...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-_MO9nyjJ.mjs");
...
const manifest = {
  "375033eb17b3ecad9eb235252e3c8121130de373e62640fa4f09a30794369d28": {
    functionName: "signFaturaByToken_createServerFn_handler",
    importer: () => import("./faturas.functions-CPIrzwHc.mjs")
  },
  "830f307385a5592bec03c7953027a3f1d4ba5570b09c7363dd75252d248c7431": {
    functionName: "getFaturaByToken_createServerFn_handler",
    importer: () => import("./faturas.functions-CPIrzwHc.mjs")
  },
  "8ef677d1135f14ebd091a59810d59b8a45b41c58b8ad539d30380bf862edbd79": {
    functionName: "getOSByToken_createServerFn_handler",
    importer: () => import("./os.functions-DGE1QzV8.mjs")
  },
  "e8d36fdab3fbb68fac8ccd641593e76aee09ca5d5412f3f624a632102bd8ac18": {
    functionName: "aprovarOSByToken_createServerFn_handler",
    importer: () => import("./os.functions-DGE1QzV8.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CkbN5ys6.mjs").then((n) => n.H),
    import("./start-CdjMA1N4.mjs"),
